module github.com/labctl/labctl
...
require (
	...
	github.com/weaveworks/libgitops v0.0.3 // indirect
...
// replace github.com/srl-labs/containerlab => ../../srl-labs/containerlab

replace (
	github.com/armon/go-metrics v0.4.1 => github.com/hashicorp/go-metrics v0.5.4
	github.com/armon/go-metrics v0.5.4 => github.com/hashicorp/go-metrics v0.5.4
	github.com/weaveworks/ignite v0.10.0 => github.com/networkop/ignite v0.0.0-20240730102642-a3f2f53f9abc
	github.com/weaveworks/libgitops => github.com/networkop/libgitops v0.0.0-20221014201752-02ecf9790f58
)
